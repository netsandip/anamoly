...
(function () {
  ...
  /** @ngInject */
  function PieChartCtrl($scope, $element, layoutPaths, baConfig) {
    ...
    var pieChart = AmCharts.makeChart(id, {
      ...
      dataProvider: $scope.$parent.useCaseOnedata,
      valueField: 'NA_',
      titleField: 'Access_Type',
      export: {
        enabled: true
      },
    ...
    pieChart.addListener('clickSlice', function (e) {
        $scope.$parent.useCaseOnedata.length = 0;
        $scope.$parent.useCaseOnedata.push(e.dataItem.dataContext);
        $scope.$apply();
    });
  }
